/// A rule is a dictionary of manipulators.
/// The manipulator is what actually match inputs to outputs.
...
//        guard !title.isEmpty else { fatalError("The rule's title cannot empty.") }
//        guard !manipulators.isEmpty else { fatalError("The rule's manipulators cannot be empty.") }

...
public extension Manipulator {
    ...
    public struct Triggers: Codable {
        ...
        public init(press: Set<Output>? = nil, pressAlone: Set<Output>? = nil, release: Set<Output>? = nil, delayed: (confirmed: Set<Output>?, cancelled: Set<Output>?)? = nil) throws {
            ...
            self.delayed = delayed.flatMap { DelayedActions($0.confirmed, cancelled: $0.cancelled) }
            guard (self.press != nil) && (self.pressAlone != nil) && (self.release != nil) && (self.delayed != nil) else {
                throw Manipulator.Error.invalidArguments("At least one manipulator's trigger must be defined.")
            }
        }
        ...
        public struct DelayedActions: Codable {
            ...
            public init?(_ confirmed: Set<Output>? = nil, cancelled: Set<Output>? = nil) {
                ...
                guard (self.confirmed != nil) && (self.cancelled != nil) else { return nil }
            }
